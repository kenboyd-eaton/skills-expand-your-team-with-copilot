    ...
    Object.entries(allActivities).forEach(([name, details]) => {
      ...
      if (currentDifficulty) {
        if (currentDifficulty === "All") {
          // "All Levels" filter selected - only show activities with no difficulty level specified
      ...
      // When currentDifficulty is empty (default "All Activities"), show all activities
